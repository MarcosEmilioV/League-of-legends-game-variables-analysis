--Game biserial correlation Challenger red team 


--Variables for point biserial correlation

SELECT SUM(redkills)/COUNT(redwins) FROM Challenger_games WHERE redwins = 1;--X1
SELECT SUM(redkills)/COUNT(redkills) FROM Challenger_games;--X
SELECT POWER(SUM(redkills)/COUNT(redkills),2) FROM Challenger_games--Xi
SELECT SQRT((POWER(SUM(redkills),2)/COUNT(redkills) - POWER(SUM(redkills)/COUNT(redkills),2))) FROM Challenger_games;--Sx
SELECT SUM(redwins)/COUNT(redwins) FROM Challenger_games;--p
SELECT (COUNT(redwins)-SUM(redwins))/COUNT(redwins) FROM Challenger_games;--q
...
SET @x1 = (SELECT SUM(redkills)/COUNT(redwins) FROM Challenger_games WHERE redwins = 1);
SET @x = (SELECT SUM(redkills)/COUNT(redkills) FROM Challenger_games);
SET @sx = (SELECT SQRT((POWER(SUM(redkills),2)/COUNT(redkills) - POWER(SUM(redkills)/COUNT(redkills),2))) FROM Challenger_games)
SET @p = (SELECT SUM(redwins)/COUNT(redwins) FROM Challenger_games)
SET @q = (SELECT (COUNT(redwins)-SUM(redwins))/COUNT(redwins) FROM Challenger_games)
...
SET @x1 = (SELECT SUM(reddragonkills)/COUNT(redwins) FROM Challenger_games WHERE redwins = 1);
SET @x = (SELECT SUM(reddragonkills)/COUNT(reddragonkills) FROM Challenger_games);
SET @sx = (SELECT SQRT((POWER(SUM(reddragonkills),2)/COUNT(reddragonkills) - POWER(SUM(reddragonkills)/COUNT(reddragonkills),2))) FROM Challenger_games)
SET @p = (SELECT SUM(redwins)/COUNT(redwins) FROM Challenger_games)
SET @q = (SELECT (COUNT(redwins)-SUM(redwins))/COUNT(redwins) FROM Challenger_games)
SET @rpb = ((@x1 - @x)/ @sx) * SQRT(@p / @q)
...
SET @x1 = (SELECT SUM(redbaronkills)/COUNT(redwins) FROM Challenger_games WHERE redwins = 1);
SET @x = (SELECT SUM(redbaronkills)/COUNT(redbaronkills) FROM Challenger_games);
SET @sx = (SELECT SQRT((POWER(SUM(redbaronkills),2)/COUNT(redbaronkills) - POWER(SUM(redbaronkills)/COUNT(redbaronkills),2))) FROM Challenger_games)
SET @p = (SELECT SUM(redwins)/COUNT(redwins) FROM Challenger_games)
SET @q = (SELECT (COUNT(redwins)-SUM(redwins))/COUNT(redwins) FROM Challenger_games)
SET @rpb = ((@x1 - @x)/ @sx) * SQRT(@p / @q)
...
SET @x1 = (SELECT SUM(redtowerkills)/COUNT(redwins) FROM Challenger_games WHERE redwins = 1);
SET @x = (SELECT SUM(redtowerkills)/COUNT(redtowerkills) FROM Challenger_games);
SET @sx = (SELECT SQRT((POWER(SUM(redtowerkills),2)/COUNT(redtowerkills) - POWER(SUM(redtowerkills)/COUNT(redtowerkills),2))) FROM Challenger_games)
SET @p = (SELECT SUM(redwins)/COUNT(redwins) FROM Challenger_games)
SET @q = (SELECT (COUNT(redwins)-SUM(redwins))/COUNT(redwins) FROM Challenger_games)
SET @rpb = ((@x1 - @x)/ @sx) * SQRT(@p / @q)
...
SET @x1 = (SELECT SUM(redtotalgold)/COUNT(redwins) FROM Challenger_games WHERE redwins = 1);
SET @x = (SELECT SUM(redtotalgold)/COUNT(redtotalgold) FROM Challenger_games);
SET @sx = (SELECT SQRT((POWER(SUM(redtotalgold),2)/COUNT(redtotalgold) - POWER(SUM(redtotalgold)/COUNT(redtotalgold),2))) FROM Challenger_games)
SET @p = (SELECT SUM(redwins)/COUNT(redwins) FROM Challenger_games)
SET @q = (SELECT (COUNT(redwins)-SUM(redwins))/COUNT(redwins) FROM Challenger_games)
SET @rpb = ((@x1 - @x)/ @sx) * SQRT(@p / @q)
